  ...
  return (
    <>
      ...
      <div className="my-5 container">
        <h1 className="mb-3 text-center cust_h1_heading" data-aos="fade-up" data-aos-duration={1500}><span className="coloredText">Innovation</span> <span className="blueColorText">and </span><span className="coloredText">quality </span><br></br><span className="blueColorText">you can rely on</span></h1>
        <p className="text-muted custm_p text-center" data-aos="fade-up" data-aos-duration={2000}>Explore our diverse range of high-quality laboratory instruments and commercial kitchen equipment, designed to deliver unmatched performance, durability, and innovation. Whether you need reliable tools for critical research or efficient solutions for your kitchen, our products are tailored to meet your specific requirements. Experience the perfect blend of technology and craftsmanship with our trusted offerings.</p>
      </div>
