  ...
  return (
    ...
    <div className='bannerImg'>
                <div className="bnnrSpc"></div>
                    <h1 className="cust_h1_heading text-center"><span className='blueColorText'>Thermomech</span></h1>
                    <p className='custm_p text-center text-muted mb-3'>- THE FUTURE OF LABS -</p>
