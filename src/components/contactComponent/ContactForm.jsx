                ...
                <form action="" className="w-100 m-auto" >
                    ...
                    <div className="mb-2 mb-lg-3 d-md-flex gap-md-3">
                        <div className="w-50">
                            ...
                            <input type="text" required placeholder="" className=" mb-md-0 p-2 custm_p bg_cust_inp_light border-1 cust_border_color w-100 rounded" />
                        </div>
                        <div className="w-50">
                            <label htmlFor="" className="fw-semibold fs-6">Company Address:<span className="text-danger">*</span></label>
                            <input type="location" required placeholder="" name="" className=" mb-md-0 p-2 custm_p w-100 bg_cust_inp_light border-1 cust_border_color rounded" />
                        </div>
                    </div>
                    <div className="mb-2 mb-lg-3 d-md-flex gap-md-3">
                        <div className="w-50">
